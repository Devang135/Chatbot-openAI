...
export default function Home() {
  ...
  return (
    <div className="container mx-auto max-w-[4000px]">
      <div className="flex flex-col h-screen bg-gray-900">
        <h1 className="bg-gradient-to-r from-teal-400 to-blue-500 text-transparent bg-clip-text text-center py-3 font-bold text-6xl">chatbot </h1>
